...
class User(Model):
    ...
    chesscom_username = fields.CharField(30, null=True, default=None)  # chess.com usernames <= 25 chars
    lichess_username = fields.CharField(30, null=True, default=None)  # lichess usernames <= 20 chars
